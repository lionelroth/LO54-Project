...
public class App
{
    public static void main( String[] args )
    {
    	...
    	Client client = new Client(courseSession6 , "Chartré", "Hardouin", "83, Chemin Des Bateliers 16000 ANGOULÊME", "0520069206", "HardouinChartre@jourrapide.com");
    	Client client1 = new Client(courseSession3 , "Cartier", "Faustin", "5, rue Grande Fusterie 69500 BRON", "0438802613", "FaustinCartier@dayrep.com");
    	Client client2 = new Client(courseSession3 , "Chartré", "Hardouin", "83, Chemin Des Bateliers 16000 ANGOULÊME", "0520069206", "HardouinChartre@jourrapide.com");
